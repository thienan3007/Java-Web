 ...
 * @author antru
 */
public class AccountSignupErrors implements Serializable {
    ...
    public AccountSignupErrors() {
    }

    public AccountSignupErrors(String idIsExisted, String passwordAndConfirmPasswordIsNotMatched, String phoneErrors, String phoneLengthErrors, String addressErrors, String idErrors, String usernameLengthErrors, String usernameErrors) {
