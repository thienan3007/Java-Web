        ...
        try {
            if (accountDTO == null) {
                ...
                if (accountDTO.getRole().getId() == 1) {
                    ...
                    if (articleDAO.deleteArticle(Integer.parseInt(articleID))) {
                        request.getRequestDispatcher("homePageControl").forward(request, response);
            ...
            log("DeleteArticleController _ SQL " + ex.getMessage());
        } catch (ClassNotFoundException ex) {
            log("DeleteArticleController _ ClassNotFound " + ex.getMessage());
        }
    }
