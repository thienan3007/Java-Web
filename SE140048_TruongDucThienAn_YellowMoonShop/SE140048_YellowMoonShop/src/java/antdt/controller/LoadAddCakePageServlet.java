 ...
 * @author antru
 */
@WebServlet(name = "LoadAddCakePageServlet", urlPatterns = {"/loadAdd"})
public class LoadAddCakePageServlet extends HttpServlet {
    public static final String addCakePage = "AddCake.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher(addCakePage).forward(request, response);
        }
    }
